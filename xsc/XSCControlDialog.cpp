...
StaticItemObj g_xscControl[] = {
	...
	StaticItemObj(_T("系列"), DEFAULT_VAL, _T("0x18f40000"), 0, 0, 2, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("车型"), DEFAULT_VAL, _T("0x18f40000"), 0, 2, 6, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("底盘"), DEFAULT_VAL, _T("0x18f40000"), 2, 0, 8, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("副发动机"), DEFAULT_VAL, _T("0x18f40000"), 3, 0, 8, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏"), DEFAULT_VAL, _T("0x18f40000"), 4, 0, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器"), DEFAULT_VAL, _T("0x18f40000"), 4, 4, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("模块1"), DEFAULT_VAL, _T("0x18f40000"), 5, 0, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("模块2"), DEFAULT_VAL, _T("0x18f40000"), 5, 4, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("语音报警器"), DEFAULT_VAL, _T("0x18f40000"), 6, 0, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("遥控"), DEFAULT_VAL, _T("0x18f40000"), 6, 4, 4, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("电机"), DEFAULT_VAL, _T("0x18f40000"), 7, 0, 8, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏程序版本号"), DEFAULT_VAL, _T("0x18f40003"), 0, 0, 16, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器程序版本号"), DEFAULT_VAL, _T("0x18f40003"), 2, 0, 16, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与控制器通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 0, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与模块1通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 1, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与模块2通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 2, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与语音通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 3, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与遥控通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 4, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与副发动机通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 5, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与车载终端通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 6, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("显示屏与底盘通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 4, 7, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与模块1通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 0, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与模块2通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 1, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与语音通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 2, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与遥控通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 3, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与副发动机通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 4, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与车载终端通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 5, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
	StaticItemObj(_T("控制器与底盘通讯状态"), DEFAULT_VAL, _T("0x18f40003"), 5, 6, 1, (PtrFuncToString)(&CXSCControlDialog::OpenOrClose)),
